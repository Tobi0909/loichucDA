...
Một web nhỏ: mở lên là tự biết đang là buổi sáng / chiều / tối (giờ Việt Nam) và hiện một lời chúc phù hợp kèm ngày tháng, thêm một dòng động viên ôn thi, đồng hồ đếm ngược tới ngày thi, hiệu ứng trái tim rơi và nút bật nhạc.
...
- `MORNING_GREETINGS`, `AFTERNOON_GREETINGS`, `NIGHT_GREETINGS` — 50+ câu mỗi buổi
- `EXAM_ENCOURAGEMENTS` — 35 câu động viên ôn thi (dòng phụ)
- `NIGHT_SOFT_NOTES` — dòng phụ buổi tối (cố ý không nhắc chuyện học)
...
- **Phân buổi:** 05:00–11:59 sáng · 12:00–17:59 chiều · 18:00–04:59 tối.
